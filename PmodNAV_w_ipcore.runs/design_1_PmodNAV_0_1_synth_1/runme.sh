...
HD_PWD='C:/Users/ihsan/Documents/Vivado_project/PmodNAV_w_ipcore/PmodNAV_w_ipcore.runs/design_1_PmodNAV_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PmodNAV_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PmodNAV_0_1.tcl
